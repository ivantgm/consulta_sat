...
<head>
    ...
    <meta name="description" content="Pesquisa de Preços Miliogo">
    <link rel="stylesheet" type="text/css" href="style.css">
    <title>Pesquisa de Preços Miliogo</title>    
</head>
<body>
    <header>
        <h1>Pesquisa de Preços Miliogo</h1>
        <nav>
            <ul>
                <li><a href="index.php">Home</a></li>
                <li><a href="db.php">Meus Cupons</a></li>
            </ul>
        </nav>
    </header>
    <main>
